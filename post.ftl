...
<@head title="${post.title!} · ${options.blog_title}" keywords="${options.seo_keywords!},${tagWords!}" description="${post.summary!}" canonical="${options.blog_url!}/archives/${post.url!}" />
<body>
        ...
        <div class="post_page">
            <div class="post animated fadeInDown">
                <div class="post_title post_detail_title">
                    <h2><a href='${options.blog_url}/archives/${post.url!}'>${post.title!}</a></h2>
