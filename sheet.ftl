...
<@head title="${sheet.title!} · ${options.blog_title}" keywords="${options.seo_keywords!}" description="${sheet.summary!}" canonical="${options.blog_url!}/s/${sheet.url!}" />
<body>
        ...
        <div class="post_page">
            <div class="post animated fadeInDown">
                <div class="post_title post_detail_title">
                    <h2><a href='${options.blog_url}/archives/${sheet.url!}'>${sheet.title!}</a></h2>
