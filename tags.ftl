...
<@head title="标签 · ${options.blog_title}" keywords="${options.seo_keywords!}" description="${options.seo_description!}" canonical="${options.blog_url!}/tags" />
<body>
            ...
            <ul>
                <@tagTag method="list">
                    <#if tags?? && tags?size gt 0>
                        <#list tags as tag>
                        <li>
                            <a href="${options.blog_url!}/tags/${tag.slugName!}">
